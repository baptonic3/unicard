// This component is loaded client-side only (via next/dynamic with ssr:false)
// to prevent @particle-network/universal-account-sdk (ESM-only) from being
// bundled in the server-side render, which would crash on Vercel.
...
export default function CheckoutPageContent({ session, item }: CheckoutPageContentProps) {
